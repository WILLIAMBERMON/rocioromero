...
<aside class="main-sidebar sidebar-light-navy elevation-4">
  ...
  <a href="/" class="brand-link">
    <img src="<?php echo getenv("LOGO_UFPS"); ?>" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
    <span class="brand-text font-weight-light"><?php echo getenv("NAME_PORTAL"); ?></span>
  </a>
