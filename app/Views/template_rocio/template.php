...
<head>
    ...
    <!-- Simplebar -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/vendor/simplebar.min.css');?>" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/app.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/app.rtl.css');?>" rel="stylesheet">

    <!-- Material Design Icons -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-material-icons.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-material-icons.rtl.css');?>" rel="stylesheet">

    <!-- Font Awesome FREE Icons -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-fontawesome-free.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-fontawesome-free.rtl.css');?>" rel="stylesheet">

    <!-- ion Range Slider -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-ion-rangeslider.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-ion-rangeslider.rtl.css');?>" rel="stylesheet">
  ...
  fbq('track', 'PageView');
    ...
    <!-- Flatpickr -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-flatpickr.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-flatpickr.rtl.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-flatpickr-airbnb.css');?>" rel="stylesheet">
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/css/vendor-flatpickr-airbnb.rtl.css');?>" rel="stylesheet">

    <!-- Vector Maps -->
    <link type="text/css" href="<?php echo base_url('/template_rocio/assets/vendor/jqvmap/jqvmap.min.css');?>" rel="stylesheet">
...
<body class="layout-default">
                                                    ...
                                                    <div class="dropdown-item d-flex">
                                                        <div class="mr-3">
                                                            <div class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('/template_rocio/assets/images/256_daniel-gaffey-1060698-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                                            </div>
                                                        </div>
                                                        <div class="flex">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                                        <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                                            ...
                                            <span class="mr-3">
                                                <img src="<?php echo base_url('/template_rocio/assets/images/frontted-logo-blue.svg');?>" width="43" height="43" alt="avatar">
                                            </span>
                                    ...
                                    <div class="list-group list-group-flush">
                                        ...
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            <div class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('/template_rocio/assets/images/256_rsz_1andy-lee-642320-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            <div class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('/template_rocio/assets/images/256_jeremy-banks-798787-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            <div class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('/template_rocio/assets/images/256_joao-silas-636453-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            <div class="avatar avatar-sm mr-3">
                                                <img src="<?php echo base_url('/template_rocio/assets/images/256_michael-dam-258165-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="tab-pane active show fade" id="activity_all">
                                            ...
                                            <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                                                ...
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        <div class="avatar avatar-xxs mr-1">
                                                            <img src="<?php echo base_url('/template_rocio/assets/images/256_luke-porter-261779-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                                        </div>
                ...
                <div class="sidebar sidebar-dark sidebar-left simplebar" data-simplebar>
                    <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account flex-shrink-0">
                        <a href="index.html" class="flex d-flex align-items-center text-underline-0 text-body">
                            <span class="mr-3">
                                <img src="<?php echo base_url('/template_rocio/assets/images/logo.svg');?>" width="43" height="43" alt="avatar">
                            </span>
                            <span class="flex d-flex flex-column">
                                <strong class="h5 text-body mb-0">FlatDash</strong>
                                <small class="text-muted text-uppercase">Bootstrap 4</small>
                            </span>
                        </a>
                        <div class="dropdown ml-auto">
                    ...
                    <div class="py-4 text-center flex-shrink-0">
                        <a href="signup.html" class="btn btn-primary w-50">Create <i class="material-icons ml-1">add</i></a>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="sm-settings" class="tab-pane sidebar-p-a">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-toggle="ion-rangeslider" data-min="0" data-max="100" data-from="50" data-step="5" data-max-postfix="+" data-prefix="$">
                            </div>
                            <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="avatar-group mt-2">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img src="<?php echo base_url('/template_rocio/assets/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg');?>" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/jquery.min.js');?>"></script>

    <!-- Bootstrap -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/popper.min.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/vendor/bootstrap.min.js');?>"></script>

    <!-- Simplebar -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/simplebar.min.js');?>"></script>

    <!-- DOM Factory -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/dom-factory.js');?>"></script>

    <!-- MDK -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/material-design-kit.js');?>"></script>

    <!-- Range Slider -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/ion.rangeSlider.min.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/ion-rangeslider.js');?>"></script>

    <!-- App -->
    <script src="<?php echo base_url('/template_rocio/assets/js/toggle-check-all.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/check-selected-row.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/dropdown.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/sidebar-mini.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/app.js');?>"></script>

    <!-- App Settings (safe to remove) -->
    <script src="<?php echo base_url('/template_rocio/assets/js/app-settings.js');?>"></script>



    <!-- Flatpickr -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/flatpickr/flatpickr.min.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/flatpickr.js');?>"></script>

    <!-- Global Settings -->
    <script src="<?php echo base_url('/template_rocio/assets/js/settings.js');?>"></script>

    <!-- Chart.js -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/Chart.min.js');?>"></script>

    <!-- App Charts JS -->
    <script src="<?php echo base_url('/template_rocio/assets/js/chartjs-rounded-bar.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/charts.js');?>"></script>

    <!-- Vector Maps -->
    <script src="<?php echo base_url('/template_rocio/assets/vendor/jqvmap/jquery.vmap.min.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/vendor/jqvmap/maps/jquery.vmap.world.js');?>"></script>
    <script src="<?php echo base_url('/template_rocio/assets/js/vector-maps.js');?>"></script>

    <!-- Chart Samples -->
    <script src="<?php echo base_url('/template_rocio/assets/js/page.dashboard.js');?>"></script>
