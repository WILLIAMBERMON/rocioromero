<div class="container-fluid">
  <div class="card card-dark">
    ...
    <div class="card-body">
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content bg-info">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6"> 
                                  <div class="form-group">
                                    <label>Código de página:</label><br>
                                    <input type="text" class="form-control" value="<?php echo $prop['codigo_pagina']; ?>" disabled>
                                  </div> 
                              </div>
                              <div class="col-md-6"> 
                                  <div class="form-group">
                              ...
                              <?php $cliente = ($prop['cliente']) ? (explode('*-*',$prop['cliente'])):''; ?>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label>Consecutivo compraventa</label>
                                  <input type="text" class="form-control" value="<?php echo ($cliente)?($cliente[1]):''; ?>" name="consecutivo" id="consecutivo" placeholder="Consecutivo de compraventa">
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" name="vender" value="<?php echo $prop['num_contrato'];?>" class="btn btn-flat btn-success pull-right "><i class="fa fa-fw fa-folder-open"></i>  Compraventa</button>
                            </div>
                          </div>
                          <!-- /.modal-content -->
                      </div>
                    ...
                    <div class="modal-content bg-info">
                      ...
                      <div class="modal-body">
                        <p  style="text-align:left" >
                          ¿Esta seguro de que desea eliminar el Expediente <?php echo $prop['codigo_pagina'];?>?
                        </p>
            ...
            <?php echo form_open_multipart(base_url($tiporeal), ['class' => 'form-horizontal', 'id' => 'form_expediente', 'role' => 'form'],['documentos'=>'1']);?>
