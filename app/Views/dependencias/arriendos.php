    ...
    <div class="card-body">
            ...
            <table id="example1s" class="datatablew table table-bordered table-striped">
              ...
              <?php foreach($data['expedientes'] as $index => $prop):?>
                <tr>
                  <td style="text-align:center;" ><?php echo $prop['contrato_arriendo'];?></td>
                  ...
                  <td style="text-align:center;" ><?php echo ($prop['estado_arriendo']);?></td>
                  ...
                  <td style="text-align:center;" >
                    ...
                    <button class="btn btn-primary regular-button botones" onclick="buscar_documentos(<?php echo "'8','".$prop['codigo']."','imagenes','agregardoc',true";?>)" title="Imagenes cargadas"> <i class="fa fa-fw fa-file-image"></i></button>
                  </td>
                  <td style="text-align:center;" >
