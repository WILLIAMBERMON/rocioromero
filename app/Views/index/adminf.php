...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url(''); ?>"><img src="<?php echo base_url('/template/img/logo_rocio.png'); ?>" data-retina="true" alt="" width="163" height="36"></a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small><a style="color:white" href="mailto:williambermon@gmail.com"><?php echo date('Y'); ?> © All Rights Reserved. Desarrollado por: WABR - División de Sistemas</a></small>
        </div>
      </div>
    </footer>
